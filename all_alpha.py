alpha_set = {'a', 'b', 'c'}
alfaset = set('abcdefghijklmnopqrstuvwxyz')
...
sentence_set = set('the big wild zoo just recently having quieted down for the known season hush keeping extra busy customers away')
print(includes_alphabet())
